...
var QuestionarioService = /** @class */ (function (_super) {
    __extends(QuestionarioService, _super);
    function QuestionarioService(http) {
        var _this = _super.call(this, http, '/api/questionarios/questionarios') || this;
        _this.http = http;
        return _this;
    }
    QuestionarioService.prototype.getQuestionarios = function (params) {
        return _super.prototype.all.call(this, params);
    };
    QuestionarioService = __decorate([
        Injectable(),
